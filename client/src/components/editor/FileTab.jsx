...
import { normalizeEditorLanguage } from "@/utils/editorLanguages"
...
function FileTab() {
    ...
    useEffect(() => {
        ...
        if (customMapping[extension]) {
            setLanguage(
                normalizeEditorLanguage(customMapping[extension]),
            )
            return
        }
        ...
        setLanguage(normalizeEditorLanguage(language[0]))
